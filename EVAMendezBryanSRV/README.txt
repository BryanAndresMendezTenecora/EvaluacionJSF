...
a persistence unit "EVAMendezBryanSRVPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ups/prueba/EVAMendezBryanSRV/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "EVAMendezBryanSRV/pom.xml":
...
artifact ("EVAMendezBryanSRV.war") is already built. You can build
